...
export default function Activity() {
    return (
        <section className="bg-orange pt-20 pb-16" style={{ backgroundImage: `url(${background})`, backgroundPosition: '-150px -170px' }}>
            ...
            <div className="lg:flex lg:flex-row lg:flex-wrap lg:justify-between max-w-[1728px] md:px-8 lg:px-16 xl:px-24 2xl:px-32 mx-auto">
                <div className="lg:basis-1/2 xl:basis-1/4 text-center pb-32 xl:pb-0">    
